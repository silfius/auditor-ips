...
def api_put_settings(request: Request, payload: Dict[str, Any] = Body(...)):
    ...
    if updated:
        ...
        label_map = {
            ...
            "automation_watchdog_enabled": "Watchdog interno automatizaciones habilitado",
            "automation_watchdog_enforce_state": "Watchdog interno aplica estado calculado",
            "automation_watchdog_missed_grace_minutes": "Watchdog margen missed",
            "automation_watchdog_stalled_minutes": "Watchdog umbral stalled",
