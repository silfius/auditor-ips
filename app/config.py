...
def cfg_defaults() -> Dict[str, Any]:
    ...
    return {
        ...
        "performance_maintenance_enabled": "1",
        "performance_maintenance_hour_utc": "3",
        "performance_maintenance_minute_utc": "30",
        "performance_health_cache_seconds": "15",
        "performance_api_cache_seconds": "10",
