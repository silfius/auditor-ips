...
- `WARN` `scripts/install_auditor.py:542` `localhost_url` — result = run_cmd(["bash", "-lc", "curl -kfsS https://127.0.0.1:${PORT:-9909}/api/system/healthz >/dev/null"], cwd=target_dir, capture=True)
